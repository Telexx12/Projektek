...
<nav class="px-2 py-3 bg-gray-300 border-gray-200">
    <div class="container flex flex-wrap items-center justify-between max-w-full px-6">
        <a href="#" class="flex items-center">
            <img src="{{asset('images/Logo.png')}}" class="h-16 sm:h-14" alt="Bali Safe Drive" />
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
            <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-300 md:flex-row md:space-x-12 md:mt-0 md:text-lg md:font-medium md:border-0 lg:space-x-16">
                <li>
        ...
        <livewire:navbar.language-select/>
    </div>
</nav>
<div class="bg-red-700 w-full h-2"></div>
