    ...
    <x-card>
        ...
        <div class="flex flex-col md:flex-row">
            <div class="flex justify-center w-full md:w-3/12">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-3/12 mb-6 md:mb-0 md:w-10/12" viewBox="0 0 48 48" version="1" enable-background="new 0 0 48 48">
            ...
            <div class="w-full md:w-9/12 flex flex-col ">
                ...
                <div class="relative">
                    <input type="text" id="input_no_comment-323"
                           ...
                           placeholder="Or ask your own question" wire:model.lazy="own_question" wire:keydown.enter="askMyQuestion">
                    <svg class="rotate-90 w-[0.95rem] absolute peer-focus:block top-3 right-3 text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" wire:click="askMyQuestion">
