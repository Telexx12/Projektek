                    ...
                    <div class="flex flex-col justify-center items-center 2xl:flex-row gap-2">
                        ...
                        <div class="w-full 2xl:w-8/12 flex flex-col items-baseline justify-center">
                            <div class="flex flex-col w-full justify-between items-center 2xl:flex-row mb-4">
                                ...
                                <?php
                                    if($this->income_monthly_change > 0)
                                ...
                                ?>
                                <h1 class="text-xs m-0 md:text-base font-extrabold md:font-bold whitespace-nowrap text-center md:text-left {{$color}} ">{{$income_monthly_change}}%
                                    @if($this->income_monthly_change == '0.00%')
                            ...
                            <div class="flex flex-col w-full justify-between items-center 2xl:flex-row mb-4">
                                ...
                                <?php
                                if($this->average_income_change > 0)
                                    $color = 'text-green-700';
                                ...
                                ?>
                                <h1 class="text-xs m-0 md:text-base font-extrabold md:font-bold whitespace-nowrap text-center md:text-left {{$color}} ">{{$average_income_change}}%
                                    @if($this->average_income_change == '0.00%')
                                        <i class="fa-solid fa-equals"></i>
                    ...
                    <div class="flex flex-col justify-center items-center 2xl:flex-row gap-2">
                        ...
                        <div class="w-full 2xl:w-8/12 flex flex-col items-baseline justify-center">
                            <div class="flex flex-col w-full justify-between items-center 2xl:flex-row mb-4">
                                ...
                                <?php
                                if($this->expens_monthly_change > 0)
                                    $color = 'text-red-700';
                                ...
                                ?>
                                <h1 class="text-xs m-0 md:text-base font-extrabold md:font-bold whitespace-nowrap text-center md:text-left {{$color}} ">{{$expens_monthly_change}}%
                                    @if($this->expens_monthly_change == '0.00%')
                                        <i class="fa-solid fa-equals"></i>
                            ...
                            <div class="flex flex-col w-full justify-between items-center 2xl:flex-row mb-4">
                                ...
                                <?php
                                if($this->average_expense_change > 0)
                                    $color = 'text-red-700';
                                ...
                                ?>
                                <h1 class="text-xs m-0 md:text-base font-extrabold md:font-bold whitespace-nowrap text-center md:text-left {{$color}} ">{{$average_expense_change}}%
                                    @if($this->average_expense_change == '0.00%')
                                        <i class="fa-solid fa-equals"></i>
                    ...
                    <div class="flex flex-col justify-center h-full items-center 2xl:flex-row gap-2">
                        ...
                        <div class="w-full 2xl:w-8/12 flex flex-col items-center justify-center">
                            <div class="flex flex-col w-full justify-center items-center 2xl:flex-row">
                                ...
                                ?>
                                <h1 class="text-xs m-0 md:text-base font-extrabold md:font-bold whitespace-nowrap text-center md:text-left {{$color}} ">{{$balance_change}}%
                                    @if($this->balance_change == '0.00%')
                                        <i class="fa-solid fa-equals"></i>
